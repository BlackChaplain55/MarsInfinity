...
"use strict";
	...
	var insertSBIntoDOM = function(){
		...
		$.getJSON("get_solar_batteries.json",	function (get_solar_batteries) {
			...
			var Power_block_B=SB_array[2].Power+SB_array[3].Power;
			var Power_block_C=SB_array[4].Power+SB_array[5].Power;
			var Power_block_D=SB_array[6].Power+SB_array[7].Power;
			...
			if (SB_array[2].status=='Норма'&SB_array[3].status=='Норма'){
			...
			if (SB_array[4].status=='Норма'&SB_array[5].status=='Норма'){
				var BlockC_stat = 'Норма'
				} else {
					BlockC_stat = SB_array[4].status!='Норма'? SB_array[4].status:'Норма'
					BlockC_stat = SB_array[5].status!='Норма'? SB_array[5].status:'Норма'
				}
			if (SB_array[6].status=='Норма'&SB_array[7].status=='Норма'){
				var BlockD_stat = 'Норма'
				} else {
					BlockD_stat = SB_array[6].status!='Норма'? SB_array[6].status:'Норма'
					BlockD_stat = SB_array[7].status!='Норма'? SB_array[7].status:'Норма'
